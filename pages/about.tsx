...
const About: FC<AboutProps> = ({ ...props }) => {
  ...
  return (
    <div data-scroll-container>
      <Container tag="div" className="about-screen">
                ...
                <>
                  <PathlineItem milestones="04/2021 - Now">
                    ...
                    <Text tag="p" variant="normal" fontWeight="normal">
                      Here, I am a Front-end developer. My main job is to
                      develop, upgrade and maintain the user interface. <br />{" "}
                      In addition, also took on a number of roles developing
                      server-side features and APIs for the company&apos;s
                      products.
